...
|------|--------|-----------|
| Create API key | Documented | API_REFERENCE_FROM_LOAD_TESTS.md |
...
| Need | Doc |
|------|-----|
| Endpoints, headers, bodies | [API_REFERENCE_FROM_LOAD_TESTS.md](API_REFERENCE_FROM_LOAD_TESTS.md) |
| Env/config mapping | Same; section "Config / env mapping" |
